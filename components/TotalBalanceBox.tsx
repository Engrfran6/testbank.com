...
import {ChevronDown, ChevronUp, DownloadIcon, SendIcon} from 'lucide-react';
          ...
          <div className="flex flex-col gap-6 w-full">
            <div className="flex flex-wrap justify-between items-center gap-4">
              ...
              <div className="flex gap-4 flex-wrap">
                <Button className="bg-[#3589FE] text-white text-sm rounded-md">
                  <Link
                    href="/dashboard/client/payment-transfer"
                    className="flex items-center gap-2">
                    Transfer money <SendIcon />
                  </Link>
                </Button>
                {/* Updated More button with dropdown */}

                <Button className="flex gap-2 border border-[#3589FE] text-white text-sm rounded-md">
                  <Link href="/dashboard/client/deposit-funds" className="flex items-center gap-2">
                    Deposit <DownloadIcon size={15} />
                  </Link>
                </Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              <div className="flex flex-col gap-2">
                <p className="text-[1.1rem] md:text-[1.3rem] font-bold text-gray-700 flex items-center gap-2">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-[.7rem] md:text-[0.9rem] text-gray-700 font-semibold flex items-center gap-2">
